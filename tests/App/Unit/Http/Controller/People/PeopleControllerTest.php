...
final class PeopleControllerTest extends TestCase
{
    ...
    private EntityQueryInterface $communityQuery;
    ...
    protected function setUp(): void
    {
        ...
        $this->communityStorage->method('getQuery')->willReturn($this->communityQuery);

        $this->entityTypeManager = $this->createMock(EntityTypeManager::class);
        $this->entityTypeManager->method('getStorage')
            ->willReturnCallback(fn (string $type): EntityStorageInterface => match ($type) {
                'resource_person' => $this->storage,
