...
final class MessageDigestCommandTest extends TestCase
{
    ...
    public function it_skips_when_mail_not_configured(): void
    {
        ...
        $command = new MessageDigestCommand($this->etm, $this->mailer, false, [], 'noreply@minoo.test', 'https://minoo.test');
        $command->execute();
    }
    ...
    public function it_skips_users_with_no_unread(): void
    {
        ...
        $command = new MessageDigestCommand($this->etm, $this->mailer, true, [], 'noreply@minoo.test', 'https://minoo.test');
        $command->execute();
    }
}
