...
return [
    ...
    'sudbury_soe.og_subtitle' => 'Spring flooding · municipal state of emergency',
    'sudbury_soe.og_image_cta' => 'City spring flooding hub + Conservation Sudbury flood status →',
    'sudbury_soe.meta_description' => 'Greater Sudbury declared a municipal state of emergency in April 2026 amid spring flooding and watershed snowmelt. Follow the city’s spring flooding page and Conservation Sudbury for orders, road impacts, and evacuations.',
    'sudbury_soe.breadcrumb' => 'Municipal emergency status',
    'sudbury_soe.gallery_h' => 'Photos',
    'sudbury_soe.soe_eyebrow' => 'Spring flooding response',
    'sudbury_soe.soe_title' => 'Greater Sudbury emergency status',
    'sudbury_soe.soe_meta' => 'Last verified {date}',
    'sudbury_soe.official_text_before' => 'For official updates, visit',
    'sudbury_soe.official_link' => 'City of Greater Sudbury — spring flooding',
    'sudbury_soe.timeline_h' => 'Timeline of updates',
    'sudbury_soe.t_22_date' => 'April 22',
    'sudbury_soe.t_22_body' => 'The city said crews are working around the clock on lift stations, sewers, and water treatment to keep services running. Residents with sewer backups should call 311 so impacts can be logged (high call volume may delay callbacks). River flooding is tracked by Conservation Sudbury — use its flood status and mapping tool to see if your address is at risk.',
    'sudbury_soe.t_21_date' => 'April 21',
    'sudbury_soe.t_21_body' => 'Mayor Paul Lefebvre declared a municipal state of emergency, calling it a precaution that speeds up decisions and helps the city prepare for localized evacuations if needed. Conservation Sudbury warned that snowpack still melting north of the city could push major rivers — including the Vermilion system — toward levels not seen in decades, with risk to McCharles, Simon, and Mud lakes and possible backflow into Junction Creek; the Whitson River corridor (including parts of Chelmsford) was also flagged. Fire Chief Rob Grimwood urged residents to watch for water above electrical outlets or gas meters.',
    'sudbury_soe.tile_status_label' => 'Municipal status',
    'sudbury_soe.tile_status_pill' => 'State of emergency',
    'sudbury_soe.tile_status_note' => 'Declaration is precautionary: it adds tools for evacuations, mutual aid, and volunteer coordination if flood impacts worsen. Conditions can change quickly as warm weather returns.',
    'sudbury_soe.tile_watershed_label' => 'Watershed & rivers',
    'sudbury_soe.tile_watershed_pill' => 'Rising water',
    'sudbury_soe.tile_watershed_note' => 'Conservation Sudbury has issued a flood warning for the area. Local reporting notes some river reaches rising sharply and continued melt from the northern watershed over the following weeks.',
    'sudbury_soe.contacts_verified' => 'Numbers and links are summarized from public city communications. Last verified {date}.',
    'sudbury_soe.contacts_notice_link' => 'Open the city’s spring flooding page',
    'sudbury_soe.contacts_note' => 'River levels, floodplain risk, and mapping are led by Conservation Sudbury alongside municipal road and utility response.',
    'sudbury_soe.contacts_notice_link_short' => 'spring flooding page',
    'sudbury_soe.c_911_name' => 'Emergency',
    'sudbury_soe.c_911_role' => 'Police · Fire · Ambulance',
    'sudbury_soe.c_311_name' => 'City of Greater Sudbury',
    'sudbury_soe.c_311_role' => '311 — municipal services, sewer backups, infrastructure',
    'sudbury_soe.info_h' => 'What’s happening',
    'sudbury_soe.info_tag' => 'Live',
    'sudbury_soe.info_p1_h' => 'City of Greater Sudbury',
    'sudbury_soe.info_p1_body' => 'The municipality declared a state of emergency in response to spring flooding risk after heavy snowmelt and rain. The city’s spring flooding hub posts response updates, road closures, evacuation readiness, and safety reminders (for example: do not drive through flooded roads; keep children away from fast water; get utility help if water nears electrical or gas equipment).',
    'sudbury_soe.info_p2_h' => 'Conservation Sudbury',
    'sudbury_soe.info_p2_body' => 'Conservation Sudbury issues watershed flood watches and warnings and publishes forecasts for local rivers and lakes. Its mapping tool lets you check whether your property sits in a flood-prone area — use that alongside the city’s notices.',
    'sudbury_soe.prep_cs' => 'Bookmark Conservation Sudbury’s flood status page and mapping tool; check them daily while warnings are active.',
    'sudbury_soe.prep_311' => 'If your basement is flooding or sewers are backing up, call 311 so the city can log the incident and prioritize response.',
    'sudbury_soe.prep_roads' => 'Never drive through flooded streets; detour around barricades only when officials say it is safe.',
    'sudbury_soe.disclaimer_1' => 'This page is not an official City of Greater Sudbury channel. It summarizes widely reported facts; confirm every detail on greatersudbury.ca and conservationsudbury.ca.',
    ...
    'sudbury_soe.community_callout_body' => 'Spring flooding and a municipal state of emergency: city response, Conservation Sudbury watershed alerts, and how to stay safe.',
