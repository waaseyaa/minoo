...
namespace App\Http\Controller\Ingestion;
...
final class IngestionDashboardController
{
    ...
    private function resolveStatusFilter(#[MapQuery] array $query): ?string
    {
    ...
    {
        $statusPath = dirname(__DIR__, 4) . '/storage/nc-sync-status.json';
