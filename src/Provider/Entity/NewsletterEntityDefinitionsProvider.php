...
/**
 * Newsletter entity type definitions only (split from {@see EntityNewsletterProvider}).
 */
final class NewsletterEntityDefinitionsProvider extends ServiceProvider
{
