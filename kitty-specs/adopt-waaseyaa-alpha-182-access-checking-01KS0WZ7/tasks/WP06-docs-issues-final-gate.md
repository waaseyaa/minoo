...
branch_strategy: Execution worktree allocated per `finalize-tasks` lane. Squash-merges back via implement-review. After this WP is approved, the mission is ready for mission-review and merge.
subtasks:
- T031
- T032
- T033
